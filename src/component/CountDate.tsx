export default function CountDate({
  ...
  return (
    <div className="CountDate flex justify-center gap-8 max-sm:gap-4 items-center w-full mt-4 max-sm:mt-3">
      <div className={`flex flex-col item-center justify-center ${level == 0 ? "scale-[120%] max-sm:scale-[115%]" : ""} ${level >= 0 ? "opacity-100" : "opacity-40"}`}>
        <img src="image/fire1.png" alt="" className="w-[30px] h-[30px] max-md:w-[20px] max-md:h-[20px] max-sm:w-[19px] max-sm:h-[19px]"/>
      ...
      <img src="image/fire2.png" alt="" className="w-[30px] h-[30px] max-md:w-[20px] max-md:h-[20px] max-sm:w-[19px] max-sm:h-[19px]"/>
      ...
      <img src="image/fire3.png" alt="" className="w-[30px] h-[30px] max-md:w-[20px] max-md:h-[20px] max-sm:w-[19px] max-sm:h-[19px]"/>
      ...
      <img src="image/fire4.png" alt="" className="w-[30px] h-[30px] max-md:w-[20px] max-md:h-[20px] max-sm:w-[19px] max-sm:h-[19px]"/>
        <p className="text-md text-white">T</p>
      </div>
      <div className={`flex flex-col item-center justify-center ${level == 4 ? "scale-[120%] max-sm:scale-[115%]" : ""} ${level >= 4 ? "opacity-100" : "opacity-40"}`}>
      <img src="image/fire5.png" alt="" className="w-[30px] h-[30px] max-md:w-[20px] max-md:h-[20px] max-sm:w-[19px] max-sm:h-[19px]"/>
